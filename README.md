...
[![dotnet-build](https://github.com/raindrovvv/UnrealAgent/actions/workflows/dotnet-build.yml/badge.svg)](https://github.com/raindrovvv/UnrealAgent/actions/workflows/dotnet-build.yml)
...
![UnrealAgent panel preview](Docs/assets/unrealagent-panel-preview.svg)
...
깨끗한 Unreal 프로젝트에서 배포 전 점검을 할 때는 [Docs/SMOKE_TEST.md](Docs/SMOKE_TEST.md)를 사용하세요.

릴리스 zip 패키지는 다음 명령으로 만들 수 있습니다.

```powershell
.\scripts\package-release.ps1 -Version 0.1.0-alpha
```

출력 파일은 `dist/UnrealAgent-0.1.0-alpha.zip`에 생성됩니다.
...
변경 이력은 [CHANGELOG.md](CHANGELOG.md), 기여 방법은 [CONTRIBUTING.md](CONTRIBUTING.md)를 참고하세요.
...
Before a broader release, use the clean-project checklist in [Docs/SMOKE_TEST.md](Docs/SMOKE_TEST.md).
...
The package is written to `dist/UnrealAgent-0.1.0-alpha.zip`.
...
See [CHANGELOG.md](CHANGELOG.md) for release history and [CONTRIBUTING.md](CONTRIBUTING.md) for contribution guidance.
